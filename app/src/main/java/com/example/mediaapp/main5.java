...
public class main5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            mediaPlayer.setDataSource("https://paglasongs.com/files/download/id/2110");
        }catch (IOException e) {
            e.printStackTrace();
        }
        mediaPlayer.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            ...
            public void onPrepared(MediaPlayer mp) { //media player object is passed as parameter
                Toast.makeText(main5.this, "Ready to PLay", Toast.LENGTH_SHORT).show(); //this toast is also an instance variable
                mp.start();
